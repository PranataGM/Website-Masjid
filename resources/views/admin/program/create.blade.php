<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center space-x-4">
            ...
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Tambah Program Baru</h2>
        </div>
    </x-slot>
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('admin.program.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="title" class="w-full border-gray-300 focus:border-emerald-500 focus:ring-emerald-500 rounded-md shadow-sm" placeholder="Contoh: Renovasi Atap Masjid, atau Pembangunan Tempat Wudhu" required>
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                <label class="block font-medium text-sm text-gray-700 mb-2">Foto / Desain Progres (Opsional)</label>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="description" rows="4" class="w-full border-gray-300 focus:border-emerald-500 focus:ring-emerald-500 rounded-md shadow-sm" placeholder="Jelaskan detail program ini, anggaran yang dibutuhkan, atau target penyelesaian..." required></textarea>
                        </div>
